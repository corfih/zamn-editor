...
;;  All this code replaces suff in the original game                          ;;
;;  Much of it is actally copied from the game and modified                   ;;
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;
...
; The +X or -X keep track of how many bytes ahead or behind the new funtion is,
...
c808739: JSR $80A4D9
         ...
         JSR loadbank80                          ; -2
;80873D: LDX $10                                 ;  0
c80873F: LDA $0010,X       ; Pallette data       ; +1
c808743: TAY
c808744: LDA $0012,X       ; Pallette data       ; +2
c808748: JSR $80A037       ; This function uses its own bank
c80874C: LDX $10                                 ; 
c80874E: LDA $0014,X       ; Sprite pallette     ; +3
c808752: TAY
c808753: LDA $0016,X       ; Sprite pallette     ; +4
         PLB                                     ; +3
c808757: JSR $80A05B
c80875B: JSR $80A079
         PHB
