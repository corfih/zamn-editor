Public Class LevelObjList
    ...
    Public Sub Add(ByVal obj As LevelObj)
        ...
        Else
            Debug.WriteLine("LevelObjList.Add(obj As LevelObj) failed because obj was not a valid type.")
            Return
        End If
        Everything.Add(obj)
    End Sub
    ...
    Public Sub Remove(ByVal obj As LevelObj)
        ...
        Else
            Debug.WriteLine("LevelObjList.Remove(obj As LevelObj) failed because obj was not a valid type.")
            Return
        End If
    ...
    Default Public Property Item(ByVal index As Integer) As LevelObj
        ...
        Set(value As LevelObj)
            ...
            Else
                Debug.WriteLine("LevelObjList.Item(index As Integer) = LevelObj failed because obj was not a valid type.")
                Return
            End If
