Public Class SpriteBrowser
    ...
    Public Overrides Sub Init()
        itemCt = gfx.ItemImages.Count + gfx.VictimImages.Count + Ptr.BossMonsters.Length - 4
    End Sub
    ...
    Public Overrides Sub PaintObject(ByVal g As System.Drawing.Graphics, ByVal x As Integer, ByVal y As Integer, ByVal num As Integer)
        ...
        Else
            g.DrawString(Ptr.BossMonsterNames(num - gfx.ItemImages.Count - gfx.VictimImages.Count + 3), BossMonster.dispfont, Brushes.Black, x, y)
        End If
    End Sub
End Class